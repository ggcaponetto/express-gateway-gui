        ...
        return (
          <Form onSubmit={(event, data) => {
            ...
            <Form.Field>
              ...
              <input placeholder='firstname' name={"firstname"} value={form.firstname} onChange={handleChange}/>
            </Form.Field>
            <Form.Field>
              <label>lastname</label>
              <input placeholder='lastname' name={"lastname"} value={form.lastname} onChange={handleChange}/>
            </Form.Field>
            <Form.Field>
              <label>redirectUri</label>
              <input placeholder='redirectUri' name={"redirectUri"} value={form.redirectUri} onChange={handleChange}/>
            </Form.Field>
            <Form.Field>
              <label>email</label>
